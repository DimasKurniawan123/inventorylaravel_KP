...
<div class="modal fade" id="modalcreate" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="barang-keluar/store" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name">Total Barang Keluar</label>
                        <input type="number" class="form-control" name="qty" placeholder="Total barang Keluar"  required>
                    </div>
                    <div class="form-group">
                        <label for="name">Tanggal Barang Keluar</label>
...
<div class="modal fade" id="modalHapus{{ $b->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="barang-keluar/destroy/{{ $b->id }}">
                @csrf
                <div class="modal-body">
